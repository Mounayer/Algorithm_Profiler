...
//    };
//
//    // Store multiple results (a vector) for each size
...
//        save(filename + ".png");
//
//        std::cout << "Finished Profiling [" << filename << "] sort." << std::endl;
//    }
//
//    static void displayAndSaveAllResults()
//    {
//        std::ofstream file("AllResults.txt");
//
...
//                std::sort(results.begin(), results.end(), [](SortResult& sr1, SortResult& sr2)-> bool
//                    {
//                        return sr1.m_time < sr2.m_time;
//                    });
//
...
//                {
//                    std::cout << (i+1) << ") Size: " << size << ", Algorithm: "
//                        << results[i].m_function_name << ", Time: "
//                        << results[i].m_time << " seconds" << std::endl;
//
//                    file << (i+1) << ") Size: " << size << ", Algorithm: "
//                        << results[i].m_function_name << ", Time: "
//                        << results[i].m_time << " seconds" << std::endl;
//                }
//
